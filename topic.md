...
* The **[San Petronio](https://it.wikipedia.org/wiki/Basilica_di_San_Petronio) "Empty Shell":** Despite its historical weight, [San Petronio](https://it.wikipedia.org/wiki/Basilica_di_San_Petronio) exists on ArCo almost entirely as a basic registry entry. It contains standard identification info but completely lacks historical data, coordinates, images, or semantic connections.
