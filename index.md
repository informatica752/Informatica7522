...
The goal of our study was to analyze how the [Basilica di San Petronio di Bologna](https://it.wikipedia.org/wiki/Basilica_di_San_Petronio) is modeled in [ArCo](https://dati.beniculturali.it/arco/index.php) , pinpoint any missing data or structural gaps, and propose semantic enhancements. To accomplish this, we integrated advanced **[SPARQL querying](https://en.wikipedia.org/wiki/SPARQL)** with **[Large Language Models (LLMs)](https://en.wikipedia.org/wiki/Large_language_model)** to generate new [RDF triples](https://en.wikipedia.org/wiki/Semantic_triple) aligned with [ArCo's official ontology](http://wit.istc.cnr.it/arco/lode/extract?lang=en&url=https://raw.githubusercontent.com/ICCD-MiBACT/ArCo/master/ArCo-release/ontologie/arco/arco.owl).
